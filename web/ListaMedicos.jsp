...
<html>
    ...
    <body>
        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td class="text-center">09782515</td>
                <td class="text-center">JUAN MANUEL</td>
                <td class="text-center">SANCHEZ</td>
                <td class="text-center">TIMANA</td>
                <td class="text-center">CARDIOLOGIA</td>
